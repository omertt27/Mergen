...
import { registerTools } from './intelligence/tools.js';
import { toolCallCounts } from './intelligence/tools.js';
import { SYSTEM_PROMPT } from './intelligence/prompts.js';
import logger from './sensor/logger.js';
import { store, setBufferSizeGetter } from './sensor/buffer.js';
import { buildCausalChain } from './intelligence/causal.js';
import { initLicense, getLicenseState, activateKey, deactivateKey, getActivePlanId } from './intelligence/license.js';
import { initUsage, getUsageSnapshot, flushOverageOnShutdown } from './intelligence/usage.js';
import { billingRouter } from './intelligence/billing.js';
import { teamRouter, initTeam, getTeamState, isTeamEnabled } from './intelligence/team.js';
...
import { initTelemetry, getTelemetryState, setTelemetryEnabled, maybeSendTelemetry } from './intelligence/telemetry.js';
