...
const heroStats = [
  ...
  { val: '< 30m',  label: 'Time to first value',     sub: 'install → replay → root cause' },
  ...
  return (
    <section className="hero">
      <span className="hero-eyebrow">
        The missing layer for AI-driven engineering teams
      </span>
      <h1>Operational Memory<br />for Production Systems.</h1>
      <p className="hero-sub">
        AI made writing code cheap. Now production failures happen faster than humans can understand them.
        Mergen turns incidents, telemetry, and human overrides into <b>structured knowledge</b> —
        so teams resolve production issues faster and prevent repeat failures.
      </p>
      <div className="hero-actions">
        <a href="/install" className="btn btn-white">Replay Your Last Incident →</a>
