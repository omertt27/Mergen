...
const plans = [
  {
    ...
    price: '$0',
    period: '/forever',
    pitch: 'Deterministic agent execution gateway on your local workstation. Local execution gate, local execution visualizer, override corpus, Git Guard pre-commit checks, and Blunder Log.',
    pilotCondition: null,
    cta: 'Get Started',
...
const matrix: { name: string; solo: Cell; team: Cell; enterprise: Cell }[] = [
  ...
  { name: 'Agent execution visualizer & replay',        solo: 'Local',  team: 'Shared', enterprise: 'Shared' },
